...
/* 전화번호 */
.telBox{width: 100%; display: flex; justify-content: space-between; align-items: center;}
.telBox>div{width: 28%; position: relative;}
.telBox>div::after {
    content: '▼';
    position: absolute;
    top: 50%;
...
.telBox input{width: 28%;}
.telBox p{width: 2.5%; height: 0.1em; background-color: #000;}
